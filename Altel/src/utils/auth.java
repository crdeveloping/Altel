...
public class auth {
    public String leerArchivo(String ruta) {
      ...
      try {
        ...
        if(Static.isWindows()){            
         archivo = new File (System.getProperty("user.home")+"\\Documents\\Altel\\Files\\"+ruta);
        }else archivo = new File (System.getProperty("user.home")+"/Documents/Altel/Files/"+ruta);
...
public void escribeFichero(String linea,String nombre) throws IOException
    {
        verificaCarpetas();
        String ruta = System.getProperty("user.home")+"/Documents/Altel/Files/"+nombre;
...
public String[] bitacora(){
    File Bitacora;
        if(Static.isWindows()){
            Bitacora = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Bitacora");
...
public String returnRow(String fileName){
        ...
        BufferedReader br;
        try {
            if(Static.isWindows())br = new BufferedReader(new FileReader(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Bitacora\\"+fileName));
            else br = new BufferedReader(new FileReader(System.getProperty("user.home")+"/Documents/Altel/Files/Bitacora/"+fileName));
        String line;
        int cuenta=0;
        try {
...
public void escribeFicheroPrint(String monto,String num,String empresa,String nombre) throws IOException
    {
        ...
        if(!fecha.equals(getMes())){
            ...
            if(listArchivos.length>0){
                while(!listArchivos[total].split("-")[1].equals(get2MesAntes())&&!fecha.equals(getMes())&&Bitacora.list().length>11){
                    ...
                    if(Static.isWindows()){
                        Bitacora = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Bitacora");                    
                        removed = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Bitacora\\"+listArchivos[total]);
                    }else{
                        Bitacora = new File(System.getProperty("user.home")+"/Documents/Altel/Files/Bitacora");                    
                        removed = new File(System.getProperty("user.home")+"/Documents/Altel/Files/Bitacora/"+listArchivos[total]);
                    }
           ...
           /* if(total>11){
                for(int i=0;i<total-11;i++){  
                    int j=i+1;
                    File removed = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Bitacora\\"+listArchivos[i]);
                    removed.delete();
                }
            }*/
       ...
       if(Static.isWindows()){                        
        ...
        File fout = new File(System.getProperty("user.home")+"/Documents/Altel/Files/Bitacora/"+getYear()+"-"+getMes()+"-"+getDia()+"-"+addCero(cuantas+"",2)+".txt");
...
public Boolean firstLogin()
    {
        File Sesion;
            File Bitacora;
        if(Static.isWindows()){
            Sesion = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Sesion");
            Bitacora = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Bitacora");
        }else{
            Sesion = new File(System.getProperty("user.home")+"/Documents/Altel/Files/Sesion");
            Bitacora = new File(System.getProperty("user.home")+"/Documents/Altel/Files/Bitacora");
        }
        //File folderSesion = new File(System.getProperty("user.home")+"\\Documents\\Altel\\Files\\Sesion");
        String ruta = System.getProperty("user.home")+"/Documents/Altel/Files/Sesion/archivoPassword.txt";        
        File archivo = new File(ruta);
        if (!archivo.exists()) {
            Sesion.mkdirs();
            Bitacora.mkdirs();
